...
ROOT_ADVANCEMENT = "core:mobs_root" # The parent for the start of new rows
INFO_FUNCTION_BASE_PATH = "core:monsters/info"
    ...
    for mob_index, (mob_name, mob_data) in enumerate(ordered_mob_data):
        ...
        if mob_index == 0:
            ...
            if previous_mob_name_overall:
                parent_advancement_id = f"core:mobs/{previous_mob_name_overall.lower().replace(' ', '_')}"
            else:
                parent_advancement_id = ROOT_ADVANCEMENT
        else: 
