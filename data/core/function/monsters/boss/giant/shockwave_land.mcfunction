...
execute positioned ~ -59 ~ as @e[distance=..13,tag=tower] run tag @s add monsters.giant_disabled
execute positioned ~ -59 ~ as @e[distance=..13,tag=tower] run tag @s add towers.disabled
