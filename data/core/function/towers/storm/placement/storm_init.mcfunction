#function core:towers/storm/placement/replace_items
...
execute unless score money. game_money matches 50.. run playsound minecraft:block.note_block.didgeridoo master @a ~ ~ ~ 2 1
execute unless score money. game_money matches 50.. run return run tellraw @a {text:"Not enough gold!",color:"gold",type:"text"}

tag @n[tag=defense.tower_square] add defense.has_tower

scoreboard players remove money. game_money 50
...
execute if score tower.rotation game_rotation matches 1 as @p[gamemode=adventure] run function core:towers/storm/placement/init_placement {rotation:"none",x_offset:"-3",z_offset:"-3",sell_cost:"50"}
execute if score tower.rotation game_rotation matches 2 as @p[gamemode=adventure] run function core:towers/storm/placement/init_placement {rotation:"clockwise_90",x_offset:"3",z_offset:"-3",sell_cost:"50"}
execute if score tower.rotation game_rotation matches 3 as @p[gamemode=adventure] run function core:towers/storm/placement/init_placement {rotation:"180",x_offset:"3",z_offset:"3",sell_cost:"50"}
execute if score tower.rotation game_rotation matches 4 as @p[gamemode=adventure] run function core:towers/storm/placement/init_placement {rotation:"counterclockwise_90",x_offset:"-3",z_offset:"3",sell_cost:"50"}