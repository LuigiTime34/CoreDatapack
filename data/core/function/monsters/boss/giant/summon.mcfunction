...
execute positioned 4 -59 146 run summon minecraft:giant ~ ~ ~ {CustomNameVisible:1b,Health:1000,NoAI:1b,Rotation:[90.0f,0.0f],Tags:["defense-monster","defense.health_display","defense-giant","defense.boss","defense.new_mob"],Team:"defense_enemies",attributes:[{id:"minecraft:max_health",base:1000},{id:"minecraft:attack_damage",base:50},{id:"minecraft:attack_knockback",base:15},{id:"minecraft:armor",base:0}],PersistenceRequired:1b}
execute as @a[advancements={core:mobs/giant=false}] run advancement grant @s only core:mobs/giant
execute positioned 4 -59 146 run scoreboard players set @n[tag=defense-giant] monster_abilities 240