...
execute unless score $money defense.money matches 10.. run return run tellraw @a {text:"Not enough gold!",color:"gold",type:"text"}
...
execute if score $tower_rotation defense.rotation matches 1 as @p[gamemode=adventure] run function core:defense/towers/panda/placement/init_placement {rotation:"none",x_offset:"-3",z_offset:"-3",sell_cost:"10"}
execute if score $tower_rotation defense.rotation matches 2 as @p[gamemode=adventure] run function core:defense/towers/panda/placement/init_placement {rotation:"clockwise_90",x_offset:"3",z_offset:"-3",sell_cost:"10"}
execute if score $tower_rotation defense.rotation matches 3 as @p[gamemode=adventure] run function core:defense/towers/panda/placement/init_placement {rotation:"180",x_offset:"3",z_offset:"3",sell_cost:"10"}
execute if score $tower_rotation defense.rotation matches 4 as @p[gamemode=adventure] run function core:defense/towers/panda/placement/init_placement {rotation:"counterclockwise_90",x_offset:"-3",z_offset:"3",sell_cost:"10"}