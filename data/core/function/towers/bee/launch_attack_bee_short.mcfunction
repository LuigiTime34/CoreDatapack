...
$execute as @s[tag=towers.upgrade_attack2] run execute if score @s towers_bee_cooldown matches 6.. run return run function core:towers/bee/launch_queen_bee {"damage":"$(damage)","speed":"$(speed)","cooldown":"$(cooldown)"}
