...
execute if score bee.money_made game_money matches 1.. at @n[tag=monster] run function tower:bee/gold_icon/summon
execute if score bee.money_made game_money matches 2.. at @n[tag=monster] run function tower:bee/gold_icon/summon
execute if score bee.money_made game_money matches 3.. at @n[tag=monster] run function tower:bee/gold_icon/summon