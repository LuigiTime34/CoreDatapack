...
execute as @n[tag=defense.storm_cloud] at @s anchored eyes run function core:towers/storm/chain/starter_raycast with storage core:storm_raycast
execute as @n[tag=defense.first_chain_target] at @s run function core:towers/storm/chain/chain_loop with storage core:storm_raycast
# Clean up
