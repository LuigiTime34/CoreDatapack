...
execute if score wave.track game_wave matches 4 run function core:monsters/summon/silverfish
execute if score wave.track game_wave matches 5 run function core:monsters/summon/spider
execute if score wave.track game_wave matches 6 run function core:monsters/summon/silverfish
...
execute if score wave.track game_wave matches 14 run function core:monsters/summon/creeper
execute if score wave.track game_wave matches 15 run function core:monsters/summon/bogged
execute if score wave.track game_wave matches 16 run function core:monsters/boss/giant/summon
execute if score wave.track game_wave matches 17 run function core:monsters/summon/creeper
execute if score wave.track game_wave matches 18 run function core:monsters/summon/creeper
