...
#> Bee tower
execute as @e[tag=towers.bee_center] at @s run function core:towers/bee/activation_ticking
...
#> Panda tower
 ...
 execute as @e[tag=towers.panda_tnt] at @s run function core:towers/panda/bomb_ticking
 execute as @e[tag=towers.panda_tnt] at @s run function core:towers/panda/bomb_ticking
 
 #: bamboom landing particles
 execute as @e[tag=towers.panda_landing] at @s run rotate @s ~6 ~
 execute as @e[tag=towers.panda_landing] at @s positioned ~ -58.5 ~ run function core:towers/panda/get_particle_range
