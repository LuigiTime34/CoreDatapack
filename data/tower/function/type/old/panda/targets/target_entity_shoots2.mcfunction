...
$function tower:global/target_mob {"range":"$(range)","reset_cooldown":"21"}
execute unless entity @n[tag=towers.target] run return run scoreboard players set @s towers_cooldown 21
