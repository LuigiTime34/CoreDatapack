...
function core:towers/bee/sell_macro with storage core:tower_sell
...
kill @e[distance=..4.3,tag=defense.bee_interaction]
kill @s
kill @n[tag=bee-center-marker]
kill @n[tag=tower-barrel-display]
kill @e[distance=..4.95,tag=defense.bee_deployer]
