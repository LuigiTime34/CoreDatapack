...
execute if entity @s[tag=!defense.queen-bee-display] positioned ~-0.5 ~ ~-0.5 if entity @n[dx=0,tag=defense-monster] run function core:defense/towers/bee/get_damage
execute if entity @s[tag=defense.queen-bee-display] positioned ~-0.5 ~-0.2 ~-0.5 if entity @n[dx=0,dy=1,tag=defense-monster] run function core:defense/towers/bee/get_damage
execute if entity @s[tag=defense.queen-bee_attacked] if score @s defense.bee_tower matches 1.. run scoreboard players remove @s defense.bee_tower 1
execute if entity @s[tag=defense.queen-bee_attacked] if score @s defense.bee_tower matches 1 run tag @s remove defense.queen-bee_attacked