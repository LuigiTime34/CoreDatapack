...
execute on passengers if entity @s[type=minecraft:bee,tag=defense.bee] if score @s game_money matches 1.. run function core:towers/bee/add_money with storage core:bee_damage
