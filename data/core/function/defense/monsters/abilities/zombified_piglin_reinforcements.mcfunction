...
summon minecraft:zombified_piglin ~ ~ ~ {CustomNameVisible:1b,Health:35,NoAI:1b,Rotation:[90.0f,0.0f],Tags:["defense-monster","defense.health_display","defense-zombified_piglin","Entity-Dummy","defense-new_piglin","defense.new_mob"],Team:"defense_enemies",attributes:[{id:"minecraft:max_health",base:35},{id:"minecraft:attack_damage",base:0},{id:"minecraft:attack_knockback",base:23},{id:"minecraft:armor",base:0}],PersistenceRequired:1b}
