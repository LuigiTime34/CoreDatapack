...
execute if score wave.track game_wave matches 5 run function core:monsters/summon/creeper
...
execute if score wave.track game_wave matches 8 run function core:monsters/summon/spider
