...
$execute if items entity @s $(slot) *[custom_data~{storm_upgrade_snow1:1b}] as @n[tag=towers.barrel_marker] at @n[tag=towers.storm_marker] run function core:towers/storm/placement/get_rotation {"building":"_snow1","cost":"150","item_slot":"19","slot_to_replace":"15"}
$execute if items entity @s $(slot) *[custom_data~{storm_upgrade_snow2:1b}] as @n[tag=towers.barrel_marker] at @n[tag=towers.storm_marker] run function core:towers/storm/placement/get_rotation {"building":"_snow2","cost":"300","item_slot":"20","slot_to_replace":"13"}
$execute if items entity @s $(slot) *[custom_data~{storm_upgrade_surge1:1b}] as @n[tag=towers.barrel_marker] at @n[tag=towers.storm_marker] run function core:towers/storm/placement/get_rotation {"building":"_surge1","cost":"150","item_slot":"21","slot_to_replace":"11"}
$execute if items entity @s $(slot) *[custom_data~{storm_upgrade_surge2:1b}] as @n[tag=towers.barrel_marker] at @n[tag=towers.storm_marker] run function core:towers/storm/placement/get_rotation {"building":"_surge2","cost":"300","item_slot":"22","slot_to_replace":"13"}
$execute if items entity @s $(slot) *[custom_data~{storm_sell:1b}] as @n[tag=towers.barrel_marker] at @n[tag=towers.storm_marker] run function core:towers/storm/sell

# PANDA UPGRADES
$execute if items entity @s $(slot) *[custom_data~{panda_upgrade1:1b}] as @n[tag=towers.barrel_marker] at @n[tag=towers.panda_marker] run function core:towers/panda/placement/get_rotation {"building":"1","cost":"20","item_slot":"0","slot_to_replace":"13"}
$execute if items entity @s $(slot) *[custom_data~{panda_upgrade_shoot1:1b}] as @n[tag=towers.barrel_marker] at @n[tag=towers.panda_marker] run function core:towers/panda/placement/get_rotation {"building":"_shoot1","cost":"150","item_slot":"1","slot_to_replace":"11"}
$execute if items entity @s $(slot) *[custom_data~{panda_upgrade_shoot2:1b}] as @n[tag=towers.barrel_marker] at @n[tag=towers.panda_marker] run function core:towers/panda/placement/get_rotation {"building":"_shoot2","cost":"300","item_slot":"2","slot_to_replace":"13"}
