...
execute positioned 4 -59 146 run summon minecraft:warden ~ ~ ~ {CustomNameVisible:1b,Health:300,NoAI:1b,Rotation:[90.0f,0.0f],Tags:["defense-monster","defense.health_display","defense-warden","Entity-Dummy","defense.boss","defense.new_mob"],Team:"defense_enemies",attributes:[{id:"minecraft:max_health",base:300},{id:"minecraft:attack_damage",base:0},{id:"minecraft:attack_knockback",base:20},{id:"minecraft:armor",base:15}],PersistenceRequired:1b}
