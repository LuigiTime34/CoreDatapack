...
execute if score #hit vdvcasttemp matches 0 positioned ~-0.05 ~-0.05 ~-0.05 as @e[dx=0,tag=defense-monster,tag=!vdvray,tag=!defense-silverfish,sort=nearest] run function core:defense/towers/bee/raycast_short/check_hit_entity
