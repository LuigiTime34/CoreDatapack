...
execute as @e[distance=..4.95,tag=defense.bee_deployer] at @s anchored eyes positioned ^ ^ ^ positioned ~ -58.9 ~ anchored feet run function core:defense/towers/bee/raycast_short/start_ray
...
execute if entity @s[tag=upgrade_attack2] run scoreboard players add @s defense.bee_cooldown 1
