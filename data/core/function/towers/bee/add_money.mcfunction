...
execute if score bee.money_made game_money matches 1.. at @n[tag=defense-monster] run function core:towers/bee/gold_icon/summon
execute if score bee.money_made game_money matches 2.. at @n[tag=defense-monster] run function core:towers/bee/gold_icon/summon
execute if score bee.money_made game_money matches 3.. at @n[tag=defense-monster] run function core:towers/bee/gold_icon/summon