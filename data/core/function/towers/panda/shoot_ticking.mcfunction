...
execute as @s[tag=towers.panda_boo_attacker,tag=!towers.panda_boo_attack] if score @s towers_panda_boo_delay matches 16 at @s run function core:towers/panda/get_damage
