...
execute if score wave.track game_wave matches 11 run function core:monsters/summon/silverfish
...
execute if score wave.track game_wave matches 14 run function core:monsters/summon/bogged
