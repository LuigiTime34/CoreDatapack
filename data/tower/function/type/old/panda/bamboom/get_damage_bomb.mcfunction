...
execute at @e[tag=towers.panda_landing] if score @s util_uuid = @n[tag=towers.panda_landing] util_uuid as @n[tag=towers.panda_landing] at @s run function tower:panda/bamboom/deal_damage_bomb with storage core:panda_damage
kill @s