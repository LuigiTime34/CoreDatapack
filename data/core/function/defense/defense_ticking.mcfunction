...
execute as @p[gamemode=adventure,x=-62,y=-50,z=123,dx=-40,dy=21,dz=-14,tag=defense-started] run attribute @s minecraft:scale base set 1
# ====================================================================================================================
#         _______ __  __
#      /\|__   __|  \/  |
#     /  \  | |  | \  / |
...
# ====================================================================================================================
execute as @e[type=minecraft:tnt] unless score @s defense.items matches 1.. run function core:defense/items/tnt/tnt_init
execute as @e[type=minecraft:tnt] at @s if score @s defense.items matches 1.. run scoreboard players remove @s defense.items 1
execute as @e[type=minecraft:tnt] at @s if score @s defense.items matches 1 run function core:defense/items/tnt/tnt_explode
# aerial view
# Change location of the marker
execute at @p[gamemode=adventure,tag=!aerial_view] as @e[tag=defense.aerial_view_marker,limit=1] unless block ~ -61 ~ minecraft:purple_wool run tp @s ~ -38 ~
# Init enter
...
# Info
execute as @a[tag=defense.aerial_view] run title @s actionbar ["",{text:"Press ",color:"green",type:"text"},{keybind:"key.sneak",color:"green",type:"keybind"},{text:" to exit, and ",color:"green",type:"text"},{keybind:"key.sprint",color:"green",type:"keybind"},{text:" to move faster.",color:"green",type:"text"}]
# Moving
...
execute if score $wave_timer defense.wave matches 0 run clear @a[gamemode=adventure] minecraft:iron_helmet
...
execute if score $mobs_left defense.wave matches ..5 if score $wave_level defense.wave matches 9.. run effect give @e[tag=defense-monster] minecraft:glowing infinite 0 true
# ====================================================================================================================
...
# Rotate snap
execute as @e[tag=defense-skeleton] on vehicle on passengers at @s run data modify entity @s Rotation set from entity @n[distance=..1,tag=defense-spider] Rotation
# Store same distance
execute as @e[tag=defense-skeleton,tag=defense.riding_spider] at @s run scoreboard players operation @s defense.distance = @n[distance=..1,tag=defense-spider] defense.distance
...
item replace entity @e[type=minecraft:witch] weapon with minecraft:air
...
execute as @e[tag=defense-monster,tag=defense-bogged] if score @s defense.bogged_health matches ..39 unless score @s defense.speed matches 38 at @s run playsound minecraft:block.trial_spawner.ominous_activate master @a ~ ~ ~ 1
...
# Silverfish
execute as @e[type=minecraft:silverfish,tag=defense-silverfish] at @s if score @s defense.abilities matches 1.. run scoreboard players remove @s defense.abilities 1
execute as @e[type=minecraft:silverfish,tag=defense-silverfish] at @s if score @s defense.abilities matches 1 run function core:defense/monsters/abilities/silverfish
execute as @e[type=minecraft:silverfish,tag=defense-silverfish] at @s if score @s defense.abilities matches 60 run function core:defense/monsters/abilities/silverfish2
...
# Rotate snap
execute as @e[tag=defense-baby_zombie,tag=!defense-monster] at @s run data modify entity @s Rotation set from entity @n[distance=..1,tag=defense-chicken] Rotation
# Store same distance
execute as @e[tag=defense-baby_zombie,tag=!defense-monster] at @s run scoreboard players operation @s defense.distance = @n[distance=..1,tag=defense-chicken] defense.distance
...
# Rotate snap
execute as @e[tag=defense-big_jockey_zombie,tag=!defense-monster] at @s run data modify entity @s Rotation set from entity @n[distance=..1.5,tag=defense-big_chicken] Rotation
# Store same distance
execute as @e[tag=defense-big_jockey_zombie,tag=!defense-monster] at @s run scoreboard players operation @s defense.distance = @n[distance=..1,tag=defense-big_chicken] defense.distance
...
execute as @e[tag=defense.creeper-death] if score @s defense.abilities matches 1 at @s positioned ~ -59 ~ run tag @e[distance=..9,tag=defense.creeper_disabled] remove defense.creeper_disabled
...
execute as @e[tag=defense.creeper_disabled] at @s unless entity @n[distance=..3.5,tag=defense.creeper_display] run summon minecraft:creeper ~ ~-3 ~ {NoAI:1b,powered:1b,attributes:[{id:"minecraft:scale",base:8.0}],Invulnerable:1b,active_effects:[{id:"minecraft:invisibility",duration:-1,show_particles:0b}],Tags:["defense.creeper_display"],Team:"defense_player"}
execute as @e[tag=defense.creeper_display] run data merge entity @s {Fire:0}
execute as @e[tag=defense.creeper_display] at @s unless entity @n[distance=..3.5,tag=defense.tower_marker] run tag @s add defense.dead_creeper_display
...
execute as @e[type=minecraft:giant,tag=defense-giant] if score @s defense.abilities matches 190 run tag @e[tag=defense.giant_disabled] remove defense.giant_disabled
...
execute as @e[tag=defense.giant_disabled] at @s run particle minecraft:block_crumble{block_state:{Name:"minecraft:dirt"}} ~ ~ ~ 2 0.1 2 0 100
...
execute at @n[tag=defense-ravager,tag=defense.ravager_speed] run particle minecraft:entity_effect{color:[0.18,0.85,0.93,1.0]} ~ ~1 ~ 1 0.5 1 0 1
...
# Warden
execute as @e[type=minecraft:warden,tag=defense-warden] if score @s defense.abilities matches 1.. run scoreboard players remove @s defense.abilities 1
execute as @e[type=minecraft:warden,tag=defense-warden] if score @s defense.abilities matches 1 at @s run function core:defense/monsters/boss/warden/sonic_boom
...
# ====================================================================================================================
# Tower Placement
execute as @p[gamemode=adventure] unless predicate core:defense/holding_placer as @e[tag=defense.tower_placer] at @s positioned ~ -60 ~ unless entity @s[distance=...1] unless entity @n[distance=..3.5,tag=tower-barrel-marker] run tp @s ~ -60 ~
execute as @p[gamemode=adventure] if predicate core:defense/holding_placer as @e[tag=defense.tower_placer] at @s positioned ~ -59 ~ unless entity @s[distance=...1] unless entity @n[distance=..3.5,tag=tower-barrel-marker] run tp @s ~ -59 ~
execute as @p[gamemode=adventure] store result score @s defense.rotation run data get entity @s Rotation[0]
execute as @e[tag=defense.tower_placer] if data entity @s interaction at @s unless entity @n[distance=..3.5,tag=panda-center-marker] on target if predicate core:defense/holding_panda positioned ~ -59 ~ run function core:defense/towers/panda/placement/panda_init
execute as @e[tag=defense.tower_placer] if data entity @s interaction at @s unless entity @n[distance=..3.5,tag=bee-center-marker] on target if predicate core:defense/holding_bee positioned ~ -59 ~ run function core:defense/towers/bee/placement/bee_init
execute as @e[tag=defense.tower_placer] if data entity @s interaction at @s unless entity @n[distance=..3.5,tag=storm-center-marker] on target if predicate core:defense/holding_storm positioned ~ -59 ~ run function core:defense/towers/storm/placement/storm_init
...
execute as @e[tag=defense.tower_placer] at @s if entity @n[distance=..3.5,tag=tower-barrel-marker] run tp @s ~ -60 ~
...
execute as @p[gamemode=adventure] if predicate core:defense/holding_placer as @e[tag=defense.tower_square,nbt=!{Glowing:1b}] at @s unless entity @n[distance=..3.5,tag=tower-barrel-marker] run data merge entity @s {Glowing:1b}
...
execute as @e[tag=defense.tower_square,tag=!defense.green] run data merge entity @s {transformation:{scale:[6.0f,6.0f,0.5f]},interpolation_duration:2,start_interpolation:0,item:{id:"minecraft:white_stained_glass_pane"}}
...
execute as @e[tag=bee-center-marker,tag=upgrade_money2,tag=!defense.off] at @s run rotate @s ~6 ~
...
execute as @e[tag=defense-monster] if score @s defense.storm.freeze_timer matches 1.. at @s run particle minecraft:snowflake ~ ~ ~ 0.2 1 0.2 0 5
...
# Freeze storm logic
execute at @e[tag=storm.freeze_storm] run particle minecraft:snowflake ~ ~ ~ 0.5 1 0.5 0 30
execute as @e[tag=defense-monster,tag=!defense-stray] at @s if entity @n[distance=..3,tag=storm.freeze_storm] run scoreboard players set @s defense.storm.freeze_power 6
execute as @e[tag=defense-monster] at @s if entity @n[distance=..3,tag=storm.freeze_storm] run scoreboard players set @s defense.storm.freeze_timer 100
...
# remove tags
execute as @e[tag=panda-center-marker,tag=!upgrade1,tag=!upgrade_shoot1,tag=!upgrade_shoot2,tag=!upgrade_bamboom1,tag=!upgrade_bamboom2] if score @s defense.towers matches 100 at @s as @e[distance=..3.5,tag=defense.panda] run tag @s remove defense.attacked
execute as @e[tag=panda-center-marker,tag=upgrade1] if score @s defense.towers matches 60 at @s as @e[distance=..3.5,tag=defense.panda] run tag @s remove defense.attacked
execute as @e[tag=panda-center-marker,tag=upgrade_shoot1] if score @s defense.towers matches 70 at @s as @e[distance=..3.5,tag=defense.panda] run tag @s remove defense.attacked
execute as @e[tag=panda-center-marker,tag=upgrade_shoot2] if score @s defense.towers matches 70 at @s as @e[distance=..3.5,tag=defense.panda] run tag @s remove defense.attacked
