...
execute store result storage core:defense.panda_range range int 0.1 run scoreboard players get @s tower_range_particle
function core:towers/panda/rotate with storage core:defense.panda_range