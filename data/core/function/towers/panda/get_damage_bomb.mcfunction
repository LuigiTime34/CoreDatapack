...
execute at @e[tag=defense.panda_landing] if score @s util_uuid = @n[tag=defense.panda_landing] util_uuid as @n[tag=defense.panda_landing] at @s run function core:towers/panda/deal_damage_bomb with storage core:panda_damage
kill @s