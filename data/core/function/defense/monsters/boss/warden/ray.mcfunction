...
execute if score #hit vdvcasttemp matches 0 positioned ~-0.05 ~-0.05 ~-0.05 as @e[dx=0,tag=defense.warden_disabled,sort=nearest] run function core:defense/monsters/boss/warden/check_hit_entity
