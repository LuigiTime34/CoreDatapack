...
execute as @e[tag=defense-monster,tag=defense-enderman] if score @s defense.entity_id = @e[type=minecraft:marker,tag=this,limit=1] defense.marker_id run tag @s add target_enderman
