...
scoreboard players operation @s[tag=monsters.ravager] monster_slowness -= ravager.speed monster_speed
...
scoreboard players operation @s monster_speed += @s monster_slowness
scoreboard players set @s[tag=monsters.enderman] monster_speed 23