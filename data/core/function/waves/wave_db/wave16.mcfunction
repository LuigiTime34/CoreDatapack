...
execute if score wave.track game_wave matches 1 run function core:monsters/summon/silverfish
...
execute if score wave.track game_wave matches 1..7 run schedule function core:waves/wave_db/wave16 3s
