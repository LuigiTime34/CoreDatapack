...
execute as @n[tag=defense.tower_square,tag=defense.green] at @s positioned ~ -58.5 ~ run function core:towers/global/squares/translate_up with entity @p[gamemode=adventure] SelectedItem.components."minecraft:custom_data"
