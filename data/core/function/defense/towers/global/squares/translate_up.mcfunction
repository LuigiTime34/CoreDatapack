execute unless entity @s[tag=defense.has_tower] if data entity @p[gamemode=adventure] SelectedItem.components."minecraft:custom_data"{bee:1b} run function core:defense/towers/global/squares/get_rotation
