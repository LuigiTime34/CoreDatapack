...
$execute as @e[tag=monster,distance=..$(range),tag=!monsters.bomb_immunity] run damage @s $(damage) minecraft:mob_attack_no_aggro by @p
$execute as @e[tag=monster,distance=..$(range),tag=!monsters.bomb_immunity] run function core:monsters/health/update
