...
function core:towers/bee/math/get_speed
...
execute if entity @s[tag=!towers.queen_bee-display] positioned ~-0.5 ~ ~-0.5 if entity @n[dx=0,tag=monster] run function core:towers/bee/math/get_damage
execute if entity @s[tag=towers.queen_bee-display] positioned ~-0.5 ~-0.2 ~-0.5 if entity @n[dx=0,dy=1,tag=monster] run function core:towers/bee/math/get_damage
