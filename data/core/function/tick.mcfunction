## Keep player alive
#effect give @a[gamemode=adventure] minecraft:saturation infinite 0 true
#effect give @a[gamemode=adventure] minecraft:resistance infinite 4 true
...
#execute as @e[type=minecraft:item,tag=!game.dmg_indicator,tag=!tower.gold_item] run data modify entity @s PickupDelay set value 0s
