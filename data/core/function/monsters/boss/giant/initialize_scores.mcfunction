...
execute as @n[tag=defense.new_giant_reinforcement] store result score @s monster_distance run scoreboard players get @n[tag=defense-reinforcement_zombie] monster_distance
