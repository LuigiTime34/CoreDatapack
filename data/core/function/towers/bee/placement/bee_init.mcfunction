...
execute if score tower.rotation game_rotation matches 1 as @a[gamemode=adventure] run function core:towers/bee/placement/init_placement {rotation:"none",x_offset:"-3",z_offset:"-3",sell_cost:"30"}
execute if score tower.rotation game_rotation matches 2 as @a[gamemode=adventure] run function core:towers/bee/placement/init_placement {rotation:"clockwise_90",x_offset:"3",z_offset:"-3",sell_cost:"30"}
execute if score tower.rotation game_rotation matches 3 as @a[gamemode=adventure] run function core:towers/bee/placement/init_placement {rotation:"180",x_offset:"3",z_offset:"3",sell_cost:"30"}
execute if score tower.rotation game_rotation matches 4 as @a[gamemode=adventure] run function core:towers/bee/placement/init_placement {rotation:"counterclockwise_90",x_offset:"-3",z_offset:"3",sell_cost:"30"}