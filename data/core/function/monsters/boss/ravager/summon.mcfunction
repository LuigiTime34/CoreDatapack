...
execute positioned 4 -59 146 run summon minecraft:ravager ~ ~ ~ {CustomNameVisible:1b,Health:540,NoAI:1b,Rotation:[90.0f,0.0f],Tags:["monster","monsters.show_health","monsters.ravager","monsters.boss","monsters.new"],Team:"defense_enemies",attributes:[{id:"minecraft:max_health",base:400},{id:"minecraft:attack_damage",base:100},{id:"minecraft:attack_knockback",base:20}],PersistenceRequired:1b}
