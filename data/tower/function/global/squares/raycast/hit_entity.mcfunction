...
execute as @n[tag=towers.square,tag=game.green] at @s positioned ~ -58.5 ~ run function tower:global/squares/translate_up with entity @p[gamemode=adventure] SelectedItem.components."minecraft:custom_data"
