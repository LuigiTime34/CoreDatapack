...
execute positioned 4 -59 146 run summon minecraft:iron_golem ~ ~ ~ {CustomName:"Iron Golem",CustomNameVisible:1b,Health:250,NoAI:1b,Rotation:[90.0f,0.0f],Tags:["moving","monster","monsters.show_health","monsters.iron_golem","monsters.boss","monsters.new"],Team:"defense_enemies",attributes:[{id:"minecraft:max_health",base:220},{id:"minecraft:attack_knockback",base:22},{id:"minecraft:armor",base:10},{id:"minecraft:attack_damage",base:0}],PersistenceRequired:1b,equipment:{body:{id:"minecraft:mud",count:1,components:{"minecraft:equippable":{slot:"body",equip_sound:"intentionally_empty"},"minecraft:item_name":"Iron Golem"}}}}
