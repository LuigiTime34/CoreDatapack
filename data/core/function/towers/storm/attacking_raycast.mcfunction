...
# Looping
$execute facing entity @n[tag=defense.storm_rod,tag=defense.rod_target] feet positioned ^$(x) ^$(y) ^.1 unless entity @n[tag=defense.storm_rod,tag=defense.rod_target,distance=..0.3] run return run function core:towers/storm/attacking_raycast with storage core:defense.storm_raycast
