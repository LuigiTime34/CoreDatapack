...
execute unless block ~ ~ ~ #core:blocks run function core:towers/bee/raycast/hit_block
...
execute if score #hit vdvcasttemp matches 0 if score #distance vdvcasttemp matches ..600 positioned ^ ^ ^0.1 run function core:towers/bee/raycast/ray