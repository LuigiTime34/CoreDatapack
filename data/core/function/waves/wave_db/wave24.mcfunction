...
execute if score wave.track game_wave matches 3 run function core:monsters/summon/silverfish
execute if score wave.track game_wave matches 4 run function core:monsters/summon/creeper
