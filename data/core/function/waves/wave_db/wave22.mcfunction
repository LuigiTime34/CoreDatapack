...
execute if score wave.track game_wave matches 7 positioned 4 -59 146 run function core:monsters/summon/silverfish
execute if score wave.track game_wave matches 1..7 run schedule function core:waves/wave_db/wave22 30t
