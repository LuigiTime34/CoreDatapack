...
$execute unless entity @n[tag=defense-monster,distance=..$(chain_radius),tag=!defense.in_chain,tag=!defense.chain_starter] run return run function core:towers/storm/chain/reset
